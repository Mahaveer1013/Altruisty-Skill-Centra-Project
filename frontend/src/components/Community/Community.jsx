      ...
      <div className="container mx-auto mb-[30px] rounded-lg max-sm:mx-[10px] max-sm:w-[100%] ">
            ...
            <div className="middle text-white">
              <div className="flex flex-col items-center w-full h-full justify-end space-y-[10px] pb-[10px]">
                ...
                <p className="text-center">
                  *Limited Registrations Only.Register befor we're filled
                </p>
              </div>
            </div>
        ...
        <div className="w-[100%] max-sm:w-[92%]  bg-white rounded-lg p-2 mb-[20px] max-sm:mx-[10px]">
          ...
          <div className="w-full flex justify-between mt-[10px] lg:px-[100px]">
            <span className="text-Darkblue flex hover:text-Yellow cursor-pointer">
              <BiLike size="30" />
              <p>Like</p>
            </span>
            <span
              className="text-Darkblue flex hover:text-Yellow cursor-pointer"
        ...
        <div className="w-[11/12] max-sm:mx-[10px] max-sm:w-[92%]  bg-white rounded-lg p-2 mb-[20px]">
          ...
          <div className="w-full flex justify-between mt-[10px] lg:px-[100px]">
            ...
            <span
              className="text-Darkblue flex hover:text-Yellow 
          cursor-pointer"
              onClick={() => setOverlayOpen(!isOverlayOpen)}
            >
              <FaRegComments size="30" />
