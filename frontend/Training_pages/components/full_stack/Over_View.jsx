...
const SyllabusSchedule = () => {
  return (
    <div className="min-h-screen p-4 flex justify-center align-middle items-center font-times rounded-xl">
      <div className="max-w-4xl mx-auto bg-white h-[400px]  overflow-x-hidden overflow-scroll md:overflow-hidden md:hover:overflow-scroll md:overflow-x-hidden   shadow-md rounded-xl border-2 border-[#F5CF6B]">
            ...
            <table className="min-w-full bg-white">
              ...
              <tbody>
                ...
                {/* <tr>
                  ...
                  <td className="py-2 px-4 border-b border-gray-300">Basic Concepts</td>
                  <td className="py-2 px-4 border-b border-gray-300"><a href=''><img className='size-10' src={drive} alt="" /></a></td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border-b border-gray-300">2</td>
                  <td className="py-2 px-4 border-b border-gray-300">Basic Concepts</td>
